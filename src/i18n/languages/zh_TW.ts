...
export const zh_TW: Translation = {
	...
	[Key.musicListLoop]: "列表循環",
	[Key.musicSingleLoop]: "單曲循環",
	...
	[Key.animeNotConfiguredDesc]:
		"請先配置 Bilibili UID 或 TMDB API Key，才能顯示追番數據。",
	...
	[Key.library]: "檔案館",
	[Key.libraryDescription]: "記錄讀過的書、看過的影視",
	[Key.libraryBooks]: "圖書收藏",
	[Key.libraryFilms]: "影視記憶",
	[Key.librarySortDate]: "時間",
	[Key.librarySortRating]: "評分",
	[Key.librarySortTitle]: "標題",
	[Key.librarySortAsc]: "升序",
	[Key.librarySortDesc]: "降序",
	[Key.libraryRatingGuide]: "評級說明",
	[Key.libraryEmpty]: "暫無內容",
};
