...
export const zh_CN: Translation = {
	...
	[Key.animeNotConfiguredDesc]:
		"请先配置 Bilibili UID 或 TMDB API Key，才能显示追番数据。",
	...
	[Key.library]: "档案馆",
	[Key.libraryDescription]: "记录读过的书、看过的影视",
	[Key.libraryBooks]: "图书收藏",
	[Key.libraryFilms]: "影视记忆",
	[Key.librarySortDate]: "时间",
	[Key.librarySortRating]: "评分",
	[Key.librarySortTitle]: "标题",
	[Key.librarySortAsc]: "升序",
	[Key.librarySortDesc]: "降序",
	[Key.libraryRatingGuide]: "评级说明",
	[Key.libraryEmpty]: "暂无内容",
};
