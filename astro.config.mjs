...
import remarkBreaks from "remark-breaks"; // 添加这个插件用于自动换行
...
const ALL_LANGUAGES = [
	...
	'csharp', 'c#', 'go', 'rust', 'php', 'ruby', 'swift', 'kotlin', 'scala', 'dart',
	'r', 'matlab', 'lua', 'perl', 'haskell', 'elixir', 'clojure', 'groovy', 'julia',
	
	// Web 相关
	'html', 'htm', 'css', 'scss', 'sass', 'less', 'vue', 'react', 'jsx', 'tsx',
	'svelte', 'angular', 'markdown', 'md', 'json', 'jsonc', 'yaml', 'yml', 'xml',
	
	// 数据库查询语言
	'sql', 'mysql', 'postgresql', 'plsql', 'sqlite',
	
	// 脚本和 shell
	'b Ash', 'sh', 'zsh', 'powershell', 'shell', 'shellsession', 'cmd',
	
	// 配置和标记语言
	'dockerfile', 'docker', 'nginx', 'apache', 'toml', 'ini', 'conf', 'cfg',
	'makefile', 'cmake', 'gradle', 'graphql', 'protobuf', 'proto',
	
	// 数据科学和 AI
	'jupyter', 'ipynb', 'pandas', 'numpy', 'tensorflow', 'pytorch',
	
	// 其他语言
	'latex', 'tex', 'bibtex', 'lisp', 'scheme', 'erlang', 'solidity', 'vyper',
	'terraform', 'hcl', 'ansible', 'yq', 'jq',
	
	// 模板引擎
	'jinja', 'jinja2', 'ejs', 'handlebars', 'mustache', 'pug', 'jade', 'njk', 'nunjucks',
	
	// 格式化语言
	'plaintext', 'text', 'txt', 'diff', 'patch', 'log',
